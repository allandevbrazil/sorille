...
export function Footer() {
  return (
    <footer className="bg-ink-charcoal px-4 py-14 text-paper md:px-8">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 md:grid-cols-3">
        <div>
          <p className="text-sm leading-relaxed text-paper/85">{CONTACT.address}</p>
        </div>
      ...
      <div className="mx-auto mt-10 max-w-6xl border-t border-white/10 pt-6 text-center text-xs text-paper/60">
        <p>
