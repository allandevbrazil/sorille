...
export function Hero() {
  return (
    <section
      id="home"
      className="relative flex min-h-[90vh] items-center overflow-hidden bg-paper pt-24 pb-16 md:pt-28"
    >
      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-10 px-4 md:grid-cols-2 md:px-8">
        <Reveal>
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-md border border-surface-muted bg-paper px-4 py-2 text-sm text-text shadow-sm transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-md"
          >
